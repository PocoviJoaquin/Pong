...
public class OpcionesModoVictoria extends JPanel implements Runnable {
	...
	public OpcionesModoVictoria() {
		...
		this.elegirPuntaje = new Resultado("ELEGIR PUNTAJE", new Font("Times New Roman", Font.PLAIN, 40), 150, 350, Color.WHITE);
		this.textoElegirPuntaje = new Resultado(puntajeGanador + "", new Font("Times New Roman", Font.PLAIN, 40), 340, 400, Color.WHITE);
		this.elegirDiferencia = new Resultado("ELEGIR DIFERENCIA DE GOL", new Font("Times New Roman", Font.PLAIN, 40), 60, 500, Color.WHITE);
		this.textoElegirDiferencia = new Resultado(diferenciaGol + "", new Font("Times New Roman", Font.PLAIN, 40), 340, 550, Color.WHITE);
		this.elegirTemporizador = new Resultado("ELEGIR CANTIDAD DE MINUTOS", new Font("Times New Roman", Font.PLAIN, 40), 150, 350, Color.WHITE);
		this.textoElegirTemporizador = new Resultado(temporizador + "", new Font("Times New Roman", Font.PLAIN, 40), 150, 400, Color.WHITE);
		this.jugar = new Resultado("JUGAR", new Font("Times New Roman", Font.PLAIN, 40), 150, 200, Color.WHITE);
