...
public class Menu extends JPanel implements Runnable {
    ...
    public Menu() {
        ...
        this.pong = new Resultado("PONG", new Font("Times New Roman", Font.PLAIN, 40), 290, 250, Color.WHITE);
        ...
        this.opciones = new Resultado("OPCIONES", new Font("Times New Roman", Font.PLAIN, 40), 240, 650, Color.WHITE);
    }
